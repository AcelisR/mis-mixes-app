...
import { Play, Pause, RotateCcw, RotateCw, ListMusic } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between gap-4 pt-1">
          ...
          <div className="flex items-center gap-3 w-1/3 min-w-0">
            <img
              src={currentMix.cover_url || DEFAULT_COVER}
              alt={currentMix.title}
              onError={(e) => { e.currentTarget.src = DEFAULT_COVER; }}
              className="w-10 h-10 rounded object-cover flex-shrink-0 border border-neutral-800"
            />
